...
It may run on other distros/versions, but the requirement is that the distro should be with *glibc-2.12* or newer. If you can't install or run bundled Thonny, then try to `install Python and Thonny separately <SeparateInstall>`_.
